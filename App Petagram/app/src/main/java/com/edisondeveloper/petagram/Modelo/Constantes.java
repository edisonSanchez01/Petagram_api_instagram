...
public class Constantes {
    ...
    public static final String GET_MEDIA_USER= "id,media_type,media_url,permalink";
    public static final String PARAM_ACCESS_TOKEN = "&access_token=";
    public static final String CLIENT_ID = "2741588446126451";
    ...
    public static final String URL_GET_MEDIA_USER = END_POINT_MEDIA + FIELDS + PARAM_ACCESS_TOKEN + ACCESS_TOKEN;
